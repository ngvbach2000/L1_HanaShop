...
<html>
    ...
    <body>
        ...
        <a href="cart.jsp"><h3>Go to cart</h3></a>
        ...
        <c:if test="${empty SearchFoodValue}">
            ...
            <c:if test="${empty LCategory}">
                ...
                <c:if test="${empty PriceFrom && empty PriceTo}">
                    <c:set var="List20Food" value="${sessionScope.LIST20FOOD}"/>
                    <c:if test="${not empty List20Food}">
                        <table border="1">
                            <thead>
                                <tr>
                                    <th>No.</th>
                            ...
                            <tbody>
                                <c:forEach var="food" items="${List20Food}" varStatus="counter">
